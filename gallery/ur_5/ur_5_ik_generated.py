...
d_0: float = 0.220941
d_2: float = -0.1719
d_4: float = 0.060108999999999996
d_5: float = 0.09465
d_6: float = 0.0823
pre_transform_special_symbol_23: float = 0.089159
...
def ur_5_ik_target_original_to_raw(T_ee: np.ndarray):
    r_11: float = T_ee[0, 0]
    r_12: float = T_ee[0, 1]
    r_13: float = T_ee[0, 2]
    Px: float = T_ee[0, 3]
...
def ur_5_ik_target_raw_to_original(T_ee: np.ndarray):
    r_11: float = T_ee[0, 0]
    r_12: float = T_ee[0, 1]
    r_13: float = T_ee[0, 2]
    Px: float = T_ee[0, 3]
...
def ur_5_fk(theta_input: np.ndarray):
...
def ur_5_twist_jacobian(theta_input: np.ndarray):
    th_0 = theta_input[0] + th_0_offset_original2raw
    th_1 = theta_input[1] + th_1_offset_original2raw
    th_2 = theta_input[2] + th_2_offset_original2raw
    th_3 = theta_input[3] + th_3_offset_original2raw
...
def ur_5_angular_velocity_jacobian(theta_input: np.ndarray):
    th_0 = theta_input[0] + th_0_offset_original2raw
    th_1 = theta_input[1] + th_1_offset_original2raw
    th_2 = theta_input[2] + th_2_offset_original2raw
    th_3 = theta_input[3] + th_3_offset_original2raw
...
def ur_5_transform_point_jacobian(theta_input: np.ndarray, point_on_ee: np.ndarray):
    th_0 = theta_input[0] + th_0_offset_original2raw
    th_1 = theta_input[1] + th_1_offset_original2raw
    th_2 = theta_input[2] + th_2_offset_original2raw
    th_3 = theta_input[3] + th_3_offset_original2raw
...
def ur_5_ik_solve_raw(T_ee: np.ndarray):
...
def ur_5_ik_solve(T_ee: np.ndarray):
    T_ee_raw_in = ur_5_ik_target_original_to_raw(T_ee)
    ik_output_raw = ur_5_ik_solve_raw(T_ee_raw_in)
    ik_output = list()
...
def test_ik_solve_ur_5():
    theta_in = np.random.random(size=(6, ))
    ee_pose = ur_5_fk(theta_in)
    ik_output = ur_5_ik_solve(ee_pose)
    for i in range(len(ik_output)):
        ee_pose_i = ur_5_fk(ik_output[i])
