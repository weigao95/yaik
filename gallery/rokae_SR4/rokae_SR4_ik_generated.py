...
# Robot parameters
a_0: float = 0.4031128874149275
a_1: float = 0.05
d_2: float = 0.4
d_3: float = -0.136
d_4: float = 0.1035
pre_transform_special_symbol_23: float = 0.355
...
th_1_offset_original2raw: float = -1.4464413322481353
th_2_offset_original2raw: float = -0.1243549945467616
...
def rokae_SR4_ik_target_original_to_raw(T_ee: np.ndarray):
    r_11: float = T_ee[0, 0]
    r_12: float = T_ee[0, 1]
    r_13: float = T_ee[0, 2]
    Px: float = T_ee[0, 3]
...
def rokae_SR4_ik_target_raw_to_original(T_ee: np.ndarray):
    r_11: float = T_ee[0, 0]
    r_12: float = T_ee[0, 1]
    r_13: float = T_ee[0, 2]
    Px: float = T_ee[0, 3]
...
def rokae_SR4_fk(theta_input: np.ndarray):
    ...
    x17 = math.sin(th_0)
    x18 = math.sin(th_3)
    x19 = -x14*x3 + x14*x4*x5
    x20 = x17*x18 + x19*x9
    x21 = x20*x8
    x22 = math.cos(th_5)
    x23 = 2.77555756156289e-17*x12
    x24 = x18*x23
    x25 = 1.0*x17*x9 - 1.0*x18*x19
    x26 = math.sin(th_5)
    x27 = x0*x12*x9 - x6*x8
    x28 = 2.77555756156289e-17*x27
    x29 = 1.0*x0*x20 - 1.0*x15*x8
    x30 = a_0*x1
    x31 = 1.0*a_0*x4
    x32 = 1.0*a_1
    x33 = 1.0*d_2
    ...
    x36 = -x10*x17 - x11*x17
    x37 = x0*x36
    x38 = -x17*x3 + x17*x4*x5
    x39 = -x14*x18 + x38*x9
    x40 = x39*x8
    x41 = -1.0*x14*x9 - 1.0*x18*x38
    x42 = 1.0*x0*x39 - 1.0*x36*x8
    x43 = 1.0*x12*x18
    x44 = 1.0*x27
    # End of temp variables
    ee_pose = np.eye(4)
    ee_pose[0, 0] = -2.77555756156289e-17*x13 - 1.0*x16 - 1.0*x21 - 2.77555756156289e-17*x7
    ee_pose[0, 1] = -x22*x24 + x22*x25 + x26*x28 + x26*x29
    ee_pose[0, 2] = x22*x28 + x22*x29 + x24*x26 - x25*x26
    ee_pose[0, 3] = a_1*x23 + 2.77555756156289e-17*d_2*x6 - d_3*x24 + d_3*x25 + 2.77555756156289e-17*d_4*x34 + x14*x31 + x15*x33 + x19*x32 - 2.77555756156289e-17*x30 + x35*(-x16 - x21)
    ee_pose[1, 0] = -1.0*x37 - 1.0*x40
    ee_pose[1, 1] = x22*x41 + x26*x42
    ee_pose[1, 2] = x22*x42 - x26*x41
    ee_pose[1, 3] = d_3*x41 + x17*x31 + x32*x38 + x33*x36 + x35*(-x37 - x40)
    ee_pose[2, 0] = -1.0*x13 - 1.0*x7
    ee_pose[2, 1] = -x22*x43 + x26*x44
    ee_pose[2, 2] = x22*x44 + x26*x43
    ee_pose[2, 3] = -d_3*x43 + 1.0*pre_transform_special_symbol_23 + x12*x32 - 1.0*x30 + x33*x6 + x34*x35
    return ee_pose


def rokae_SR4_twist_jacobian(theta_input: np.ndarray):
    th_0 = theta_input[0] + th_0_offset_original2raw
    th_1 = theta_input[1] + th_1_offset_original2raw
    th_2 = theta_input[2] + th_2_offset_original2raw
    th_3 = theta_input[3] + th_3_offset_original2raw
    ...
    x6 = math.cos(th_0)
    x7 = 1.0*x6
    x8 = -2.77555756156289e-17*x4 - x5*x7
    x9 = math.sin(th_2)
    x10 = 1.0*x4*x6 - 2.77555756156289e-17*x5
    x11 = -x10*x9 + x3*x8
    x12 = math.cos(th_3)
    x13 = math.sin(th_3)
    x14 = x10*x3 + x8*x9
    ...
    x20 = x1*x4
    x21 = -x19*x3 - x20*x9
    x22 = 1.0*x0*x3*x4 - x19*x9
    x23 = -x12*x7 - x13*x22
    x24 = -x16*x21 - x17*(x12*x22 - x13*x7)
    x25 = 1.0*x9
    x26 = 1.0*x3
    x27 = x25*x5 - x26*x4
    x28 = -x25*x4 - x26*x5
    ...
    jacobian_output[3, 1] = -pre_transform_special_symbol_23*x7
    jacobian_output[3, 2] = -x33*x7
    jacobian_output[3, 3] = -x21*x34 + x27*x35
    jacobian_output[3, 4] = -x23*x36 - x29*x37
    jacobian_output[3, 5] = -x24*x38 + x30*x39
    jacobian_output[4, 0] = 2.77555756156289e-17*pre_transform_special_symbol_23
    jacobian_output[4, 1] = -pre_transform_special_symbol_23*x1
    jacobian_output[4, 2] = -x1*x33
    jacobian_output[4, 3] = x11*x34 - x27*x41
    jacobian_output[4, 4] = x15*x36 + x29*x42
    jacobian_output[4, 5] = x18*x38 - x30*x43
    jacobian_output[5, 2] = x0**2*x31*x4 + x40*x7
    jacobian_output[5, 3] = -x11*x35 + x21*x41
    jacobian_output[5, 4] = -x15*x37 + x23*x42
    jacobian_output[5, 5] = -x18*x39 + x24*x43
    return jacobian_output


def rokae_SR4_angular_velocity_jacobian(theta_input: np.ndarray):
    th_0 = theta_input[0] + th_0_offset_original2raw
    th_1 = theta_input[1] + th_1_offset_original2raw
    th_2 = theta_input[2] + th_2_offset_original2raw
    th_3 = theta_input[3] + th_3_offset_original2raw
    ...
    jacobian_output[0, 2] = x2
    jacobian_output[0, 3] = x11
    jacobian_output[0, 4] = 1.0*x0*x12 - x13*x14
    jacobian_output[0, 5] = -x11*x15 - x16*(x1*x13 + x12*x14)
    jacobian_output[1, 1] = x7
    jacobian_output[1, 2] = x7
    jacobian_output[1, 3] = x18
    jacobian_output[1, 4] = -x12*x7 - x13*x19
    jacobian_output[1, 5] = -x15*x18 - x16*(x12*x19 - x13*x7)
    jacobian_output[2, 0] = 1.00000000000000
    jacobian_output[2, 3] = x22
    jacobian_output[2, 4] = -x13*x23
    jacobian_output[2, 5] = -x12*x16*x23 - x15*x22
    return jacobian_output


def rokae_SR4_transform_point_jacobian(theta_input: np.ndarray, point_on_ee: np.ndarray):
    th_0 = theta_input[0] + th_0_offset_original2raw
    th_1 = theta_input[1] + th_1_offset_original2raw
    th_2 = theta_input[2] + th_2_offset_original2raw
    th_3 = theta_input[3] + th_3_offset_original2raw
    ...
    x36 = 1.0*x14
    x37 = p_on_ee_z*x36
    x38 = -2.77555756156289e-17*x11 - x2*x4
    x39 = 1.0*x1*x11 - 2.77555756156289e-17*x4
    x40 = x10*x38 - x39*x8
    x41 = a_0*x39
    x42 = x10*x39 + x38*x8
    x43 = a_1*x42 + d_2*x40 + x41
    x44 = 1.0*x14*x25 - x23*x42
    x45 = d_3*x44 + x43
    x46 = -x29*x40 - x30*(x23*x36 + x25*x42)
    x47 = d_4*x46 + x45
    x48 = x1*x35
    x49 = x0*x14
    # End of temp variables
    ...
    jacobian_output[1, 0] = -2.77555756156289e-17*p_on_ee_z + 2.77555756156289e-17*pre_transform_special_symbol_23 + x35
    ...
    jacobian_output[1, 4] = -p_on_ee_x*x24 - p_on_ee_z*x44 + x18*x23*x45 + x27*x44
    jacobian_output[1, 5] = p_on_ee_x*x31 - p_on_ee_z*x46 - x31*x47 + x33*x46
    jacobian_output[2, 0] = 2.77555756156289e-17*p_on_ee_y
    jacobian_output[2, 1] = -x48 - x49
    jacobian_output[2, 2] = x14**2*x20 + x2*x41 - x48 - x49
...
def rokae_SR4_ik_solve_raw(T_ee: np.ndarray):
    ...
    def SolvedVariableDispatcherNode_node_22_processor():
        ...
        for i in range(len(this_node_input_index)):
            ...
            degenerate_valid_0 = (abs(th_2 - math.pi + 1.44644133224814) <= 1.0e-6)
            if degenerate_valid_0:
                taken_by_degenerate = True
                add_input_index_to(32, node_input_i_idx_in_queue)
            
            th_2 = this_solution[4]
            degenerate_valid_1 = (abs(th_2 - 2*math.pi + 1.44644133224814) <= 1.0e-6)
            if degenerate_valid_1:
                taken_by_degenerate = True
    ...
    def ExplicitSolutionNode_node_35_solve_th_4_processor():
        ...
        for i in range(len(this_node_input_index)):
            ...
            condition_0: bool = (abs(0.992277876713668*a_0 + d_2) >= zero_tolerance) or (abs(d_4 + inv_Pz) >= zero_tolerance) or (abs(inv_Px*math.cos(th_5) - inv_Py*math.sin(th_5)) >= zero_tolerance)
            if condition_0:
                # Temp variable for efficiency
                x0 = inv_Px*math.cos(th_5) - inv_Py*math.sin(th_5)
                x1 = d_4 + inv_Pz
                x2 = math.atan2(x0, x1)
                x3 = 0.992277876713668*a_0 + d_2
            ...
            condition_1: bool = (abs(0.992277876713668*a_0 + d_2) >= zero_tolerance) or (abs(d_4 + inv_Pz) >= zero_tolerance) or (abs(inv_Px*math.cos(th_5) - inv_Py*math.sin(th_5)) >= zero_tolerance)
            if condition_1:
                # Temp variable for efficiency
                x0 = inv_Px*math.cos(th_5) - inv_Py*math.sin(th_5)
                x1 = d_4 + inv_Pz
    ...
    def ExplicitSolutionNode_node_37_solve_th_1_processor():
        ...
        for i in range(len(this_node_input_index)):
            ...
            this_solution = solution_queue[node_input_i_idx_in_queue]
            th_5 = this_solution[7]
            condition_0: bool = (abs(0.992277876713668*a_1 - 0.124034734589209*d_2) >= zero_tolerance) or (abs(a_0 + 0.124034734589209*a_1 + 0.992277876713668*d_2) >= zero_tolerance) or (abs(Pz + d_3*r_31*math.sin(th_5) + d_3*r_32*math.cos(th_5) - d_4*r_33) >= zero_tolerance)
            if condition_0:
                # Temp variable for efficiency
                x0 = a_0 + 0.124034734589209*a_1 + 0.992277876713668*d_2
                x1 = math.atan2(x0, -0.992277876713668*a_1 + 0.124034734589209*d_2)
                x2 = -Pz - d_3*r_31*math.sin(th_5) - d_3*r_32*math.cos(th_5) + d_4*r_33
                x3 = safe_sqrt(x0**2 - x2**2 + 0.984615384615385*(-a_1 + 0.125*d_2)**2)
                # End of temp variables
                solution_0: IkSolution = copy.copy(this_solution)
                solution_0[1] = x1 + math.atan2(x3, x2)
                appended_idx = append_solution_to_queue(solution_0)
                
            condition_1: bool = (abs(0.992277876713668*a_1 - 0.124034734589209*d_2) >= zero_tolerance) or (abs(a_0 + 0.124034734589209*a_1 + 0.992277876713668*d_2) >= zero_tolerance) or (abs(Pz + d_3*r_31*math.sin(th_5) + d_3*r_32*math.cos(th_5) - d_4*r_33) >= zero_tolerance)
            if condition_1:
                # Temp variable for efficiency
                x0 = a_0 + 0.124034734589209*a_1 + 0.992277876713668*d_2
                x1 = math.atan2(x0, -0.992277876713668*a_1 + 0.124034734589209*d_2)
    ...
    def ExplicitSolutionNode_node_34_solve_th_4_processor():
        ...
        for i in range(len(this_node_input_index)):
            ...
            th_3 = this_solution[5]
            condition_0: bool = (1 >= zero_tolerance) or (abs(-r_13*((-0.992277876713668*math.sin(th_1) - 0.124034734589208*math.cos(th_1))*math.cos(th_0)*math.cos(th_3) + math.sin(th_0)*math.sin(th_3)) - r_23*((-0.992277876713668*math.sin(th_1) - 0.124034734589208*math.cos(th_1))*math.sin(th_0)*math.cos(th_3) - math.sin(th_3)*math.cos(th_0)) - r_33*(0.124034734589208*math.sin(th_1) - 0.992277876713668*math.cos(th_1))*math.cos(th_3)) >= zero_tolerance) or (abs(-r_13*(-0.124034734589209*math.sin(th_1) + 0.992277876713668*math.cos(th_1))*math.cos(th_0) - r_23*(-0.124034734589209*math.sin(th_1) + 0.992277876713668*math.cos(th_1))*math.sin(th_0) + r_33*(0.992277876713668*math.sin(th_1) + 0.124034734589209*math.cos(th_1))) >= zero_tolerance)
            if condition_0:
                # Temp variable for efficiency
                x0 = math.cos(th_3)
                x1 = math.sin(th_1)
                x2 = math.cos(th_1)
                x3 = -0.992277876713668*x2
                x4 = math.sin(th_0)
                x5 = math.sin(th_3)
                x6 = math.cos(th_0)
                x7 = 0.992277876713668*x1
                x8 = x0*(-0.124034734589208*x2 - x7)
                x9 = -0.124034734589209*x1 - x3
                # End of temp variables
                this_solution[6] = math.atan2(-r_13*(x4*x5 + x6*x8) - r_23*(x4*x8 - x5*x6) - r_33*x0*(0.124034734589208*x1 + x3), r_13*x6*x9 + r_23*x4*x9 - r_33*(0.124034734589209*x2 + x7))
                solution_queue[node_input_i_idx_in_queue] = this_solution
            else:
                queue_element_validity[node_input_i_idx_in_queue] = False
...
def rokae_SR4_ik_solve(T_ee: np.ndarray):
    T_ee_raw_in = rokae_SR4_ik_target_original_to_raw(T_ee)
    ik_output_raw = rokae_SR4_ik_solve_raw(T_ee_raw_in)
    ik_output = list()
    for i in range(len(ik_output_raw)):
        ...
        ee_pose_i = rokae_SR4_fk(ik_out_i)
...
def test_ik_solve_rokae_SR4():
    theta_in = np.random.random(size=(6, ))
    ee_pose = rokae_SR4_fk(theta_in)
    ik_output = rokae_SR4_ik_solve(ee_pose)
    for i in range(len(ik_output)):
        ee_pose_i = rokae_SR4_fk(ik_output[i])
